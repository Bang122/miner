...
:W10
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --dualmode ETCHASH --dualpool !ETCPOOL! --dualuser !ETCWALLET! --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --dualmode ETCHASH --dualpool !ETCPOOL! --dualuser !ETCWALLET! --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
