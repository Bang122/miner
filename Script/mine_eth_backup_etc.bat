...
:W10
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --pool etc:!ETCPOOL! --user !ETCWALLET! --watchdog exit
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --pool etc:!ETCPOOL! --user !ETCWALLET! --watchdog exit --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
