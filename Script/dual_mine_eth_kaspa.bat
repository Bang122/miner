...
:W10
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --worker !WORKER! --dualmode KASPADUAL --dualpool !KASPAPOOL! --dualuser !KASPAWALLET! --dualworker !WORKER! !EXTRAPARAMETERS! --watchdog exit
timeout 10
goto W10
goto END

:OtherW
"%MyVariable%" --algo ETHASH --pool !POOL! --user !WALLET! --worker !WORKER! --dualmode KASPADUAL --dualpool !KASPAPOOL! --dualuser !KASPAWALLET! --dualworker !WORKER! !EXTRAPARAMETERS! --watchdog exit --nocolor
timeout 10
goto OtherW
