...
set "POOL=ethash.infiniteton.com:4444"
set "WALLET=EQCTMUSkNT0GDfoWTESpHmp1CH4UdSekrD3rcd1PtFoktqXC"										

set "EXTRAPARAMETERS=--worker TestWorker"
...
:W10
"%MyVariable%" -a ETHASH --pool !POOL! --user !WALLET!  --watchdog exit !EXTRAPARAMETERS!
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%" -a ETHASH --pool !POOL! --user !WALLET! --watchdog exit !EXTRAPARAMETERS! --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
