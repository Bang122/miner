...
set "POOL=stratum.pool-node.com:8020"
set "WALLET=0x6808A37357936BF72C10962F148C7B5d5427c1b0.lolMinerWorker"										
...
:W10
"%MyVariable%" -a UBQHASH --pool !POOL! --user !WALLET!  --watchdog exit !EXTRAPARAMETERS!
if %ERRORLEVEL% == 42 (
	timeout 10
	goto W10
)
...
:OtherW
"%MyVariable%" -a UBQHASH --pool !POOL! --user !WALLET! --watchdog exit !EXTRAPARAMETERS! --nocolor
if %ERRORLEVEL% == 42 (
	timeout 10
	goto OtherW
)
